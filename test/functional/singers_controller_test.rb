...
class SingersControllerTest < ActionController::TestCase
  ...
  test "should create singer" do
    assert_difference('Singer.count') do
      post :create, singer: { bio: @singer.bio, lastname: @singer.lastname, name: @singer.name, skill: @singer.skill, voicepart: @singer.voicepart }
    end
  ...
  test "should update singer" do
    put :update, id: @singer, singer: { bio: @singer.bio, lastname: @singer.lastname, name: @singer.name, skill: @singer.skill, voicepart: @singer.voicepart }
    assert_redirected_to singer_path(assigns(:singer))
  end
